// Mostly from https://github.com/mhart/aws4fetch/blob/master/src/main.js
...
export default class AwsClient {
    ...
    constructor({ accessKeyId, secretAccessKey, sessionToken, service, region, cache, retries, initRetryMs, url }: AWSClientParams) {
    ...
    async sign(input: RequestInfo, init?: AwsRequestInit): Promise<Request> {
...
export class AwsV4Signer {
    ...
    readonly signQuery: boolean | undefined
    readonly appendSessionToken: boolean
    readonly signableHeaders: string[]
    readonly signedHeaders: string
    readonly canonicalHeaders: string
    readonly credentialString: string
    readonly encodedPath: string
    readonly encodedSearch: string

    constructor({ method, url, headers, body, accessKeyId, secretAccessKey, sessionToken, service, region, cache, datetime, signQuery, appendSessionToken, allHeaders, singleEncode }: AwsV4SignerOptions) {
